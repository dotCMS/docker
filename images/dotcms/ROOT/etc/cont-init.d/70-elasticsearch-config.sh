...
if [[ -z "${PROVIDER_ELASTICSEARCH_DNSNAMES}" ]]; then
    ...
    echo "PROVIDER_ELASTICSEARCH_DNSNAMES=" >>/srv/docker-container/config/settings.ini
    echo "PROVIDER_ELASTICSEARCH_CLUSTER_NAME=${PROVIDER_ELASTICSEARCH_CLUSTER_NAME}" >>/srv/docker-container/config/settings.ini
    echo "PROVIDER_ELASTICSEARCH_ADDR_TRANSPORT=127.0.0.1" >>/srv/docker-container/config/settings.ini
    echo "PROVIDER_ELASTICSEARCH_PORT_TRANSPORT=${PROVIDER_ELASTICSEARCH_PORT_TRANSPORT}" >>/srv/docker-container/config/settings.ini
    echo "PROVIDER_ELASTICSEARCH_ADDR_HTTP=${PROVIDER_ELASTICSEARCH_ADDR_HTTP}" >>/srv/docker-container/config/settings.ini
    echo "PROVIDER_ELASTICSEARCH_PORT_HTTP=${PROVIDER_ELASTICSEARCH_PORT_HTTP}" >>/srv/docker-container/config/settings.ini
    echo "PROVIDER_ELASTICSEARCH_ENABLE_HTTP=${PROVIDER_ELASTICSEARCH_ENABLE_HTTP}" >>/srv/docker-container/config/settings.ini
...
echo "PROVIDER_ELASTICSEARCH_CLUSTER_NAME=${PROVIDER_ELASTICSEARCH_CLUSTER_NAME}" >>/srv/docker-container/config/settings.ini
echo "PROVIDER_ELASTICSEARCH_ADDR_TRANSPORT=${PROVIDER_ELASTICSEARCH_ADDR_TRANSPORT}" >>/srv/docker-container/config/settings.ini
echo "PROVIDER_ELASTICSEARCH_PORT_TRANSPORT=${PROVIDER_ELASTICSEARCH_PORT_TRANSPORT}" >>/srv/docker-container/config/settings.ini
echo "PROVIDER_ELASTICSEARCH_ADDR_HTTP=${PROVIDER_ELASTICSEARCH_ADDR_HTTP}" >>/srv/docker-container/config/settings.ini
echo "PROVIDER_ELASTICSEARCH_PORT_HTTP=${PROVIDER_ELASTICSEARCH_PORT_HTTP}" >>/srv/docker-container/config/settings.ini
echo "PROVIDER_ELASTICSEARCH_ENABLE_HTTP=${PROVIDER_ELASTICSEARCH_ENABLE_HTTP}" >>/srv/docker-container/config/settings.ini
